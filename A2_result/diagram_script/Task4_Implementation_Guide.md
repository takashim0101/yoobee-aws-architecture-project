...
*   **Steps:**
    ...
    2.  **Interpret Available Checks and Document Findings:**
        *   Access the AWS Trusted Advisor console and confirm the available checks under the Free Tier (e.g., **"MFA on Root Account"** and **"Security Groups - Specific Ports Unrestricted"**).
...
Amazon Web Services. (2025). *What is AWS Compute Optimizer?* AWS Documentation. https://docs.aws.amazon.com/compute-optimizer/latest/ug/what-is-compute-optimizer.html
Amazon Web Services. (2025). *AWS CloudTrail features*. Amazon Web Services. https://aws.amazon.com/cloudtrail/features/